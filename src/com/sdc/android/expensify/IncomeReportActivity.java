...
public class IncomeReportActivity extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String selectQuery = "SELECT * from reciepts where acctitle=?";
		...
		while (c1.moveToNext()) {
			...
			final_amt+=amount;
			 String data=c1.getString(c1.getColumnIndex("income_cat"))+"		"+amount+"		"+c1.getString(c1.getColumnIndex("date"));
			 list1.add(data);
		}
